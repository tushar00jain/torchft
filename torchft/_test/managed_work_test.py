...
from typing import Callable, List, Optional, TypeVar, cast, Dict, Tuple
...
class TestManagedWork(unittest.TestCase):
    ...
    def test_callbacks_execute_after_wait(
        ...
        manager.wrap_future = types.MethodType(
    ...
    def test_callbacks_changing_return_types(
        ...
        def callback2(fut: Future[Dict[str, torch.Tensor]]) -> Tuple[torch.Tensor, float]:
            data = fut.value()
