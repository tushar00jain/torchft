...
class TestManagedWork(unittest.TestCase):
    ...
    def test_callbacks_execute_after_wait(self, name: str, device: torch.device) -> None:
    ...
    def test_multiple_callbacks_execute_in_order(self, name: str, device: torch.device) -> None:
