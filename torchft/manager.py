...
T = TypeVar("T")
AllReduceCallback: TypeAlias = Callable[[torch.futures.Future[torch.Tensor]], None]
...
class Manager:
    ...
    def allow_checkpoint(self) -> None:
        self._checkpoint_transport.allow_checkpoint(self.current_step())
