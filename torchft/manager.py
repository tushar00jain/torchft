        ...
        while managed_fut._next:
            ...
            def callback(
                ...
                with (
                    ...
                    result = managed_fut._callback(
                        _SimpleFuture(fut.value()),
                    )
                    return result
            ...
            managed_fut._fut = self._manager.wrap_future(managed_fut._fut, self._value)
