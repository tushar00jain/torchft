...
from torchft.test.diloco_trainer import DiLoCoTrainer, MultiModel
...
def handle_fixture(
    ...
    fixture_path = os.path.join(script_directory, "fixtures", fixture_filename)
...
class DiLoCoMockedUpdateTest(TestCase):
    ...
    def test_diloco_mocked_updates(
        ...
        # If no fixuture exists we can't compare results
        if fixture_data is not None:
            ...
            # validate that parameters are updated as expected
